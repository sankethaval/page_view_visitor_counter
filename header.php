...
<html>
  ...
  <body bgcolor=#efefef style="margin: 0px;">
       ...
       <table width=750 height=100% bgcolor=#aaccff cellpadding=0 cellspacing=0 align=center>
           <tr><td align=center class=head>
                          HIOX Unique Counter<br>
           </td></tr>
	   ...
	   <tr align=center><td height=10> 
		  ...
		  <tr align=center>
			  ...
			  <td valign=top>
			   ...
			   <a class=links href="http://hscripts.com/support.php">Report</a>&nbsp;|&nbsp;
			   <a class=links href="passwrd.php">Change Password</a>&nbsp;
			</td><td width=15%> 
		   	   <a class=links style="color: red;" href="about.php?out=signout">Sign out&nbsp;&nbsp;</a>
		   </td></tr>
		  </table>
	   </td></tr>
           <tr>
